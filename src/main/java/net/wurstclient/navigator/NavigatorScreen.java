...
public abstract class NavigatorScreen extends Screen {
	...
	@Override
	public final boolean mouseDragged(double mouseX, double mouseY, int mouseButton, double double_3, double double_4) {
		// scrollbar
		...
		return super.mouseDragged(mouseX, mouseY, mouseButton, double_3, double_4);
	}
	...
	protected abstract void onMouseDrag(double mouseX, double mouseY, int button, double double_3, double double_4);
