...
public final class TacoCmd extends Command implements GUIRenderListener, UpdateListener {
	private final Identifier[] tacos = { new Identifier("wurst", "dancingtaco1.png"), new Identifier("wurst", "dancingtaco2.png"), new Identifier("wurst", "dancingtaco3.png"), new Identifier("wurst", "dancingtaco4.png") };
