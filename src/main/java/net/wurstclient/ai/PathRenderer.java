...
public final class PathRenderer {
	public static void renderArrow(BlockPos start, BlockPos end) {
		...
		glRotated(Math.toDegrees(Math.atan2(endY - startY, startZ - endZ)) + 90, 1, 0, 0);
		glRotated(Math.toDegrees(Math.atan2(endX - startX, Math.sqrt(Math.pow(endY - startY, 2) + Math.pow(endZ - startZ, 2)))), 0, 0, 1);
