...
public final class EditItemListScreen extends Screen {
	...
	public void init() {
		...
		itemNameField = new TextFieldWidget(minecraft.textRenderer, width / 2 - 152, height - 55, 150, 18, "");
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		drawCenteredString(minecraft.textRenderer, itemList.getName() + " (" + listGui.getItemCount() + ")", width / 2, 12, 0xffffff);
		...
		if (itemNameField.getText().isEmpty() && !itemNameField.isFocused()) {
			...
			drawString(minecraft.textRenderer, "item name or ID", 68, height - 50, 0x808080);
			GL11.glPopMatrix();
		}
		...
		listGui.renderIconAndGetName(new ItemStack(itemToAdd), 52, height - 52, false);
