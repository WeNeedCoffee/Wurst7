...
public final class RadarComponent extends Component {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		for (Entity e : hack.getEntities()) {
			double diffX = e.lastRenderX + (e.getX() - e.lastRenderX) * partialTicks - (player.lastRenderX + (player.getX() - player.lastRenderX) * partialTicks);
			double diffZ = e.lastRenderZ + (e.getZ() - e.lastRenderZ) * partialTicks - (player.lastRenderZ + (player.getZ() - player.lastRenderZ) * partialTicks);
