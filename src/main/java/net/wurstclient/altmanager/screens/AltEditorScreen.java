...
public abstract class AltEditorScreen extends Screen {
	...
	public final void init() {
		...
		addButton(new ButtonWidget(width / 2 - 100, height / 4 + 120 + 12, 200, 20, "Cancel", b -> minecraft.openScreen(prevScreen)));

		addButton(new ButtonWidget(width / 2 - 100, height / 4 + 96 + 12, 200, 20, "Random Name", b -> emailBox.setText(NameGenerator.generateName())));

		addButton(stealSkinButton = new ButtonWidget(width - (width / 2 - 100) / 2 - 64, height - 32, 128, 20, "Steal Skin", b -> message = stealSkin(getEmail())));

		addButton(new ButtonWidget((width / 2 - 100) / 2 - 64, height - 32, 128, 20, "Open Skin Folder", b -> openSkinFolder()));
		...
		passwordBox = new TextFieldWidget(font, width / 2 - 100, 100, 200, 20, "");
