...
public final class AutoSoupHack extends Hack implements UpdateListener {
	private final SliderSetting health = new SliderSetting("Health", "Eats a soup when your health\n" + "reaches this value or falls below it.", 6.5, 0.5, 9.5, 0.5, ValueDisplay.DECIMAL);
	...
	public void onUpdate() {
		...
		for (int i = 0; i < 36; i++) {
			...
			boolean swap = !emptyBowlStack.isEmpty() && emptyBowlStack.getItem() != Items.BOWL;
