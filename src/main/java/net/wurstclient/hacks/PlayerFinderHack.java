...
public final class PlayerFinderHack extends Hack implements UpdateListener, PacketInputListener, RenderListener {
	...
	public void onUpdate() {
		...
		ChatUtils.message("PlayerFinder has detected a player near " + pos.toShortString() + ".");
		lastPos = pos;
	}
	...
	public void onReceivedPacket(PacketInputEvent event) {
		...
		if (packet instanceof PlaySoundS2CPacket) {
			...
			EntitySpawnGlobalS2CPacket lightning = (EntitySpawnGlobalS2CPacket) packet;
