...
public final class AutoSplashPotHack extends Hack implements UpdateListener {
	private final SliderSetting health = new SliderSetting("Health", 6, 0.5, 9.5, 0.5, ValueDisplay.DECIMAL);

	private int timer;

	public AutoSplashPotHack() {
		super("AutoSplashPot", "Automatically throws instant health splash potions if your health is lower than or equal to\n" + "the set value.");
