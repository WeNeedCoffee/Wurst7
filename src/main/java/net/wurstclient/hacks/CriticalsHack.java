...
public final class CriticalsHack extends Hack implements LeftClickListener {
	...
	private enum Mode {
		PACKET("Packet"), MINI_JUMP("Mini Jump"), FULL_JUMP("Full Jump");
