...
public final class InstantBunkerHack extends Hack implements UpdateListener, RenderListener {
	private final int[][] template = { { 2, 0, 2 }, { -2, 0, 2 }, { 2, 0, -2 }, { -2, 0, -2 }, { 2, 1, 2 }, { -2, 1, 2 }, { 2, 1, -2 }, { -2, 1, -2 }, { 2, 2, 2 }, { -2, 2, 2 }, { 2, 2, -2 }, { -2, 2, -2 }, { 1, 2, 2 }, { 0, 2, 2 }, { -1, 2, 2 }, { 2, 2, 1 }, { 2, 2, 0 }, { 2, 2, -1 }, { -2, 2, 1 }, { -2, 2, 0 }, { -2, 2, -1 }, { 1, 2, -2 }, { 0, 2, -2 }, { -1, 2, -2 }, { 1, 0, 2 }, { 0, 0, 2 }, { -1, 0, 2 }, { 2, 0, 1 }, { 2, 0, 0 }, { 2, 0, -1 }, { -2, 0, 1 }, { -2, 0, 0 }, { -2, 0, -1 }, { 1, 0, -2 }, { 0, 0, -2 }, { -1, 0, -2 }, { 1, 1, 2 }, { 0, 1, 2 }, { -1, 1, 2 }, { 2, 1, 1 }, { 2, 1, 0 }, { 2, 1, -1 }, { -2, 1, 1 }, { -2, 1, 0 }, { -2, 1, -1 }, { 1, 1, -2 }, { 0, 1, -2 }, { -1, 1, -2 }, { 1, 2, 1 }, { -1, 2, 1 }, { 1, 2, -1 }, { -1, 2, -1 }, { 0, 2, 1 }, { 1, 2, 0 }, { -1, 2, 0 }, { 0, 2, -1 }, { 0, 2, 0 } };
	...
	public void onUpdate() {
		...
		if (!building && startTimer <= 0) {
			for (BlockPos pos : positions)
				if (BlockUtils.getState(pos).getMaterial().isReplaceable() && !MC.player.getBoundingBox().intersects(new Box(pos)))
